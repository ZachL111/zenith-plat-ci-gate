"""Regression checks for the zenith-plat-ci-gate casebook."""
...
from casebook.harness import assert_expected, zenith_plat_ci_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_plat_ci_gate_summary(), assert_expected())
